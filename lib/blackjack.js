...
BlackjackGame.prototype.joinTable = function (id) {
  ...
  if(this.players.length < 3) {
    ...
    this.result = id + " se unió a la mesa.";
  } else {
    this.result = "Mesa llena. :(";
  }
...
BlackjackGame.prototype.startRound = function() {
  ...
  this.result = "Nueva ronda con los jugadores actuales.";
...
BlackjackGame.prototype.calculateWinner = function() {
  ...
  if(winners.length < 1) {
    ...
    this.result = "¡Ganan los jugadores! " + winnersList;
  }
};
